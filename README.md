...
- `end_percent`: `1.0`
- `only_anima`: `true`
- `optimize_outside_range`: `false`

For CFG 1 turbo-style workflows, enable the LoRA or acceleration method you are using, set sampler CFG to `1.0`, use its recommended step count, and set `optimize_outside_range` to `true`.
